...
var CognitoService = /** @class */ (function () {
    ...
    CognitoService.prototype.findUserByCpf = function (cpf) {
        return __awaiter(this, void 0, void 0, function () {
            var command, response, user, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        command = new client_cognito_identity_provider_1.ListUsersCommand({
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, { cpf: user.Username || "" }];
                    case 3:
                        err_1 = _a.sent();
                        console.error("Erro ao buscar usuário:", err_1);
                        throw err_1;
